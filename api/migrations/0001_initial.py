# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-08-04 16:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caller', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.Caller')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('platform', models.CharField(choices=[('Android', 'Android'), ('iOS', 'iOS'), ('Blackberry', 'Blackberry')], max_length=20)),
                ('status', models.IntegerField(choices=[(1, 'Active'), (0, 'Inactive')], default=1)),
                ('api_request_key', models.CharField(max_length=255)),
        ...
        #     model_name='callercategory',
        #     name="assign_type",
        #     field=models.IntegerField(choices=[(1, 'Private'), (2, 'Global')]),
        # ),
        # migrations.AddField(
        #     model_name='callercategory',
        #     name="assigned_date",
        ...
        migrations.AddField(
            model_name='caller',
            name='category',
            field=models.ManyToManyField(through='api.CallerCategory', to='api.Category'),
        ),
        migrations.AddField(
            model_name='caller',
